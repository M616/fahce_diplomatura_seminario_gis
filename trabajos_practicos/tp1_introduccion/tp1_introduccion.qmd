...
### 1) Tipo de Vectores. Carga y exploración de datos
...
Podés ajustar colores, nombres de capas y niveles de transparencia para hacer tus visualizaciones más claras y efectivas. Recordá que mapview() no se renderiza en PDF, pero sí en HTML o desde RStudio.
